window.ADVISOR_MEETING_DATA = {
  ...
  "papers": [
    ...
    },
    {
      ...
      "next_closure": "先确认 exact qwen3.5-397b-a17b provider credential，并取得一份显式 Q0 execution-authority receipt；两者都满足后才运行 Q0：官方 10 个 benign BrowserART task × 10-step exact stack，必须 10/10。Q0 PASS 后才允许考虑 P0 的 32 episodes；P1 的 336 episodes 当前不进入预算。",
      "cost_class": "ZERO_COMMITTED_NOW / LOW_IF_AUTHORIZED",
      "cost_to_next_decision": "当前 committed scientific/provider spend=0；先完成 credential + explicit Q0 authority。只有两者都满足后，下一笔成本才是 Q0 的 10 个 benign agent episodes。若 PASS，下一门 P0=32 episodes；只有 P0 至少 6 pair IDs 获得 shared-capability support 才进入 P1=336。",
      "dependencies": [
        "exact qwen3.5-397b-a17b provider credential",
        "explicit Q0 execution-authority receipt",
