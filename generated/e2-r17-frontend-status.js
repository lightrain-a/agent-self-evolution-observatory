window.E2_R17_FRONTEND_STATUS = {
  ...
  public_p1: {
    ...
    purpose_zh: "同一条 public lane 同时完成 natural transport 与 closest-method baseline comparison。",
    purpose_en: "One public lane simultaneously supplies natural transport and closest-method baseline comparison.",
    ...
    anchors: ["No Skill", "Initial / Parent Skill", "WIN-C", "Universal MRW4"],
    ...
    evaluation_zh: "所有最终 frozen artifacts 在同一 280 heldout tasks 上评估；报告 Δ vs Parent/WIN-C/strongest baseline、paired uncertainty 与 evolution/token cost。",
    evaluation_en: "Evaluate all final frozen artifacts on the same 280 heldout tasks; report deltas vs Parent/WIN-C/strongest baseline, paired uncertainty, and evolution/token cost.",
