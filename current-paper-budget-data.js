window.CURRENT_PAPER_BUDGET={
  ...
  rows:[
    ...
    },
    {
      ...
      envelope:{zh:"当前只允许静态设计 / qualification work；provider credit 恢复后先做独立 readiness check → 新 R2 capability ledger → Direct-SFQ-A0。不得重跑旧 R1、不得回退 contaminated CodingPlan actor。",en:"Only static design/qualification work is currently open. After provider credit recovery: independent readiness check → new R2 capability ledger → Direct-SFQ-A0. Old R1 cannot be replayed and the contaminated CodingPlan actor cannot be used as fallback."},
      cash:{zh:"中 · 近期只需 12-case SFQ + capability recovery；只有 RQ1 phenomenon 通过后才会扩到 matched topology / prospective prediction / GTCC。",en:"Medium · near-term cost is limited to capability recovery plus the 12-case SFQ; matched topology, prospective prediction, and GTCC expand only after RQ1 passes."},
