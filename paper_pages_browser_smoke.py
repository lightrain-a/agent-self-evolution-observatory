    ...
    try:
        ...
        for page,formal,markers in pages:
            ...
            if page=="paper-e1.html":
                require(all(x in v["text"] for x in ("skillmisevo-coding-06-P19","user_id='skillmisevo'","limit=5","0.488896795303","0.437164326961","doubao-seed-2.0-lite","未随当前发布仓库物化")),f"E1 concrete replay lost frozen anchors: {v}")
