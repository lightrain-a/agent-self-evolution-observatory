    ...
    try:
        ...
        for page,formal,markers in pages:
            ...
            if page=="paper-e1.html":
                ...
                layers=execute(sid,"""return {terms:document.querySelectorAll('.cpp-e1-term-fold').length,termsOpen:!!document.querySelector('.cpp-e1-term-fold')?.open,related:document.querySelectorAll('.cpp-e1-related-fold').length,relatedOpen:!!document.querySelector('.cpp-e1-related-fold')?.open,successor:document.querySelectorAll('.cpp-e1-successor-fold').length,successorOpen:!!document.querySelector('.cpp-e1-successor-fold')?.open,registry:document.querySelectorAll('.cpp-e1-registry-fold').length,registryOpen:!!document.querySelector('.cpp-e1-registry-fold')?.open,project:document.querySelectorAll('.cpp-e1-project-fold').length,projectOpen:!!document.querySelector('.cpp-e1-project-fold')?.open};""")
                require(layers=={"terms":1,"termsOpen":False,"related":1,"relatedOpen":False,"successor":1,"successorOpen":False,"registry":1,"registryOpen":False,"project":1,"projectOpen":False},f"E1 beginner folds drifted: {layers}")
            else:
