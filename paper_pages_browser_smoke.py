    ...
    try:
        ...
        for page,formal,markers in pages:
            ...
            if page=="paper-e1.html":
                require(v["e1WhySplit"]==1 and v["e1SplitReasons"]==4 and v["e1SplitFlight"]==4 and v["e1WorkedExample"]==1 and v["e1Packages"]==4 and v["e1Flights"]==3 and v["e1EvidenceGlance"]==3 and v["e1EvidenceLadder"]==1 and v["e1ExperimentArc"]==4 and v["e1ClaimRows"]==3 and v["e1Review"]==1 and "6.1" in v["e1ReviewScore"] and "Accept" in v["e1ReviewScore"] and v["e1ReviewHistory"]==1 and not v["e1ReviewHistoryOpen"] and v["e1Budget"]==1,f"E1 golden-template contract failed: {v}")
