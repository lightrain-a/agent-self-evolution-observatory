...
def main():
    ...
    try:
        ...
        require(collection["states"][7]=="CREDIT STOP",f"paper 8 status chip must stay compact/current: {collection['states'][7]}")
