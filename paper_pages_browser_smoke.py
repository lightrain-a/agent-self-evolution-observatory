    ...
    try:
        ...
        for page,formal,markers in pages:
            ...
            if page=="paper-e1.html":
                require(all(x in v["text"] for x in ("skillmisevo-coding-06-P19","user_id='skillmisevo'","limit=5","0.488896795303","0.437164326961","doubao-seed-2.0-lite","hashing-256","Scaffold a brand-new example service repo",".git/hooks/post-checkout","单独完成整项任务的概率")),f"E1 concrete replay lost frozen anchors: {v}")
                require(v["e1WhySplit"]==1 and v["e1SplitReasons"]==4 and v["e1SplitFlight"]==4 and v["e1WorkedExample"]==1 and v["e1Packages"]==4 and v["e1Flights"]==3 and v["e1SystemDataflow"]==1 and v["e1SystemRoles"]==7 and v["e1SystemFlow"]==8 and v["e1WhoSelects"]==3 and v["e1P19Concrete"]==0 and v["e1P19Contrast"]==0 and v["e1P19Controls"]==0 and v["e1FullReplay"]==1 and v["e1ReplayFrames"]==10 and v["e1ReplayTop5"]==2 and v["e1ReplayControls"]==4 and v["e1Teaching"]==1 and not v["e1TeachingOpen"] and v["e1MethodGlance"]==1 and v["e1MethodSteps"]==5 and v["e1BeginnerRule"]==1 and v["e1BeginnerTech"]==1 and not v["e1BeginnerTechOpen"] and v["e1DeepTech"]==1 and not v["e1DeepTechOpen"] and v["e1EvidenceGlance"]==3 and v["e1EvidenceLadder"]==1 and v["e1ExperimentArc"]==6 and v["e1ClaimRows"]==3 and v["e1Review"]==1 and "6.1" in v["e1ReviewScore"] and "Accept" in v["e1ReviewScore"] and v["e1ReviewHistory"]==1 and not v["e1ReviewHistoryOpen"] and v["e1Budget"]==1,f"E1 golden-template contract failed: {v}")
            else:
