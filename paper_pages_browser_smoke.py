    ...
    try:
        ...
        for page,formal,markers in pages:
            ...
            if formal:
                ...
                require(v["origin"]==0 and v["related"]>=1 and v["nearest"]>=1 and v["storyArchive"]==1 and v["workingAudit"]==1 and v["novelty"]==0 and v["externalReview"]==0 and v["objection"]==0 and v["acceptance"]==0 and v["registry"]==0,f"working-paper audit contract failed {page}: {v}")
