...
9. `selected-paper.html` — current paper collection: nine formal papers, working papers, and independent scientific objects; detailed story/model/data/experiment/evolution content lives on the nine dedicated paper pages.
