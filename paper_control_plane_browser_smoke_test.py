...
def main() -> None:
    ...
    try:
        ...
        expected_download_supplements = {"downloads/STRI-ICLR2027-supplement.zip", "downloads/Agent-Safety-R9-supplement.zip", "downloads/D2-PAPER-PROXY-REWARD-MEMORY-VARIANCE-supplement.zip", "downloads/D2-PAPER-TEMPORAL-SKILL-CAUSAL-BOTTLENECK-supplement.zip", "downloads/D2-PAPER-FAILURE-MEMORY-PROVENANCE-supplement.zip"}
