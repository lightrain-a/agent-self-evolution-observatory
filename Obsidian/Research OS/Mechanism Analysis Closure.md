...
12. **Zero/low-cost D0.** Before expensive execution, verify that the residual is measurable/manipulable on outcome-independent support, the proposed gate/representation is non-degenerate, and the added validity signal is incrementally informative beyond demoted baselines.
13. **Go/Stop symmetry.** Both success and failure must change the next paper decision.
