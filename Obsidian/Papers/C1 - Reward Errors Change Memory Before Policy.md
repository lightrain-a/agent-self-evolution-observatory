...
- A neutral memory plus reward metadata is therefore a **strong simple baseline**, not a contribution.
...
The novelty candidate is **not** core/residual factorization alone and **not** provenance alone. The residual object being tested is narrower:

> the semantic residual induced by counterfactual success/failure reflection of the same trajectory, plus evidence-/target-conditioned authority for that residual.
