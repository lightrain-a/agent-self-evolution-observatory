...
def main() -> None:
    ...
    try:
        ...
        require("ASSET-FIRST ICLR 2027 · PAPER QUALITY V2.1" in system["text"] and "Paper Quality v2.1" in system["text"] and "PASS · receipt binding=PASS · content-addressed=PASS (20 files) · evidence debt=0" in system["text"] and "60/60 PASS" in system["text"] and "60/60 PASS" in system["text"] and "main=9/9 pages" in system["text"] and "tests=29/29 PASS" in system["text"] and f"Problem-Gate PASS={int(canonical_queue_summary.get('passed_problem_gate') or 0)}" in system["text"], "asset-first STRI Paper Quality v2/canonical dual-track status is not rendered")
