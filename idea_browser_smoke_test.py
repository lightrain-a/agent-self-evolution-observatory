...
def main() -> None:
    ...
    try:
        ...
        require(selected["currentSTRI"] == 1 and selected["currentAgentSafety"] == 1 and selected["archive"] == 1 and not selected["archiveOpen"] and selected["acceptancePanels"] == 2 and selected["acceptanceStages"] == 24, f"PaperRegistry must render two current paper details, two independent 12-stage acceptance workflows, and one collapsed historical archive: {selected}")
        ...
        dual_ready_markers=("PaperRegistry","SUBMISSION_READY","AGENT-SAFETY-R9","4 update-only / 0 control-only","非当前 PaperState · 历史归档","真正 Submission Ready=2","Manuscript CI=9/9 PASS","Prebuttal=PASS","论文侧闭环已经完成")
