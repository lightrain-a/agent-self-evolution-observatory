...
def main() -> None:
    ...
    try:
        ...
        require((ecs.get("paper_ready"),ecs.get("paper_quality_hold"),ecs.get("paper_quality_evidence_debt"),ecs.get("canonical_live_ideas"),ecs.get("launchable_formal_experiments"),ecs.get("shadow_dead_ends"),ecs.get("shadow_holds"),ecs.get("shadow_qualification_ready")) == (1,0,0,0,0,11,2,0), f"experiments current-status snapshot is stale: {ecs}")
