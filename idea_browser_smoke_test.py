...
def main() -> None:
    ...
    try:
        ...
        require(int(sds.get("near_miss_preflight_dead_ends") or 0)+int(sds.get("near_miss_holds") or 0) == 5 and (sds.get("near_miss_support_holds"),sds.get("near_miss_terminal_support_holds"),sds.get("near_miss_current_primary_stops"),sds.get("near_miss_mature_theory_stops")) == (1,1,2,1) and (sds.get("shadow_dead_end_objects"),sds.get("principle_readjudication_dead_ends"),sds.get("shadow_hold_objects")) == (12,8,3), f"near-miss/principle dead-end/HOLD memory accounting is inconsistent: {sds}")
        ...
        require((ecs.get("paper_ready"),ecs.get("paper_quality_hold"),ecs.get("paper_quality_evidence_debt"),ecs.get("canonical_live_ideas"),ecs.get("launchable_formal_experiments"),ecs.get("shadow_dead_ends"),ecs.get("shadow_holds"),ecs.get("shadow_qualification_ready"),ecs.get("fresh_active_f0"),ecs.get("fresh_support_holds"),ecs.get("fresh_ready_problem_review"),ecs.get("method_authorized"),ecs.get("gpu_authorized")) == (1,0,0,0,0,12,3,0,1,3,0,0,0), f"experiments current-status snapshot is stale: {ecs}")
