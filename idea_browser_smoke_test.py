...
def main() -> None:
    ...
    try:
        ...
        require((ideas["shadowDesignSummary"].get("reviewed"),ideas["shadowDesignSummary"].get("advance_to_method_design"),ideas["shadowDesignSummary"].get("revise_paper_problem"),ideas["shadowDesignSummary"].get("stop_standalone"),ideas["shadowDesignSummary"].get("near_miss_preflight_dead_ends"),ideas["shadowDesignSummary"].get("near_miss_support_holds"),ideas["shadowDesignSummary"].get("near_miss_current_primary_stops")) == (2,0,1,1,2,1,1), f"shadow Search Portfolio design/near-miss routing is stale: {ideas['shadowDesignSummary']}")
        ...
        require("Shadow Search Portfolio · retrospective Paper Design audit" in ideas["text"] and "Shadow Search Portfolio · latest current-source terminal" in ideas["text"] and "qualifying query-level units=0" in ideas["text"] and "near-miss memory=2" in ideas["text"], "shadow Paper Design/latest terminal/near-miss/SP-15 support results are not rendered")
