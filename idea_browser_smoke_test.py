...
def main() -> None:
    ...
    try:
        ...
        require("ASSET-FIRST ICLR 2027 SUBMISSION-READY" in system["text"] and "READY_TO_SUBMIT_PENDING_HUMAN_AUTHOR_SIGNOFF_AND_OPENREVIEW" in system["text"] and "59/59 PASS" in system["text"] and "50/50 PASS" in system["text"] and "main=9/9 pages" in system["text"] and "tests=11/11 PASS" in system["text"] and f"Problem-Gate PASS={int(canonical_queue_summary.get('passed_problem_gate') or 0)}" in system["text"], "asset-first STRI official submission/canonical dual-track status is not rendered")
