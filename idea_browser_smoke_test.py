...
def main() -> None:
    ...
    try:
        ...
        require((experiments["terminalStarted"],experiments["terminalPending"],experiments["auditQueue"],experiments["auditItems"]) == (14,6,1,6), f"started/pending audit split is wrong: {experiments}")
