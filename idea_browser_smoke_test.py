...
def main() -> None:
    ...
    try:
        ...
        require(all(marker in zh_system_text for marker in ("科学闭环不等于论文已经成熟","问题必要性、Challenge 与 Related Work","方法核心 Intuition、设计理念与全部关键细节","更完整的实验 Program，而不是只有一张主表","讲人话：清晰、直白、易懂的论文写作")), "system-overview Chinese paper-development guidance is incomplete")
        ensure_language("en")
