...
def main() -> None:
    ...
    try:
        ...
        dual_ready_markers=("PaperRegistry","SUBMISSION_READY","AGENT-SAFETY-R9","4 update-only / 0 control-only","非当前 PaperState · 历史归档","内部已闭环=4","仍有内部动作=1","Research OS 下一步","EXTERNAL_EVIDENCE_REQUIRED","NO_INTERNAL_ACTION","Temporal Skills Are a Causal Bottleneck","Failure Memories Are Not Neutral","HOLD_FOR_EVIDENCE","Paper Preparation=1/8 FAIL","Manuscript CI=9/9 PASS","Prebuttal=PASS","论文侧闭环已经完成")
