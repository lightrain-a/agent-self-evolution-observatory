...
def main() -> None:
    ...
    try:
        ...
        require((experiments["terminalStarted"],experiments["terminalPending"],experiments["auditQueue"],experiments["auditItems"]) == (12,8,1,8), f"started/pending audit split is wrong: {experiments}")
