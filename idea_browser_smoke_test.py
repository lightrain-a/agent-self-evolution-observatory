...
def main() -> None:
    ...
    try:
        ...
        require("Shadow Search Portfolio · retrospective Paper Design audit" in ideas["text"] and "Shadow Search Portfolio r2 · current-source terminal" in ideas["text"] and "qualifying query-level units=0" in ideas["text"] and "near-miss memory=2" in ideas["text"], "shadow Paper Design/r2 terminal/near-miss/SP-15 support results are not rendered")
