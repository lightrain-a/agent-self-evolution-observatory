...
def main() -> None:
    ...
    try:
        ...
        require("PaperRegistry" in selected["text"] and "TARGETED_REPAIR" in selected["text"] and "AGENT-SAFETY-R9" in selected["text"] and "CAUSAL_HOLD" in selected["text"] and "非当前 PaperState · 历史归档" in selected["text"] and "先完成 Targeted Repair，再进入 Claim Audit" in selected["text"] and "真正 Submission Ready=0" in selected["text"], "PaperRegistry / STRI acceptance boundary or historical archive is missing")
