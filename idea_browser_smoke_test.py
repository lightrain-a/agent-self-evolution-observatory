...
def main() -> None:
    ...
    try:
        ...
        require("Shadow Search Portfolio · retrospective Paper Design audit" in ideas["text"] and "Shadow Search Portfolio · latest current-source terminal" in ideas["text"] and "qualifying query-level units=0" in ideas["text"] and "current-source hard-veto memory=2" in ideas["text"] and "semantic reduction/lane memory=4" in ideas["text"] and "near-miss memory=8" in ideas["text"] and "terminal support HOLD=4" in ideas["text"] and "last terminal memory=shadow-20260814-r4b" in ideas["text"] and "mature-theory STOP=1" in ideas["text"] and "execution-censored=2" in ideas["text"] and "problem-falsifier=0" in ideas["text"], "shadow Paper Design/latest terminal/execution/dead-end/SP-15 results are not rendered")
