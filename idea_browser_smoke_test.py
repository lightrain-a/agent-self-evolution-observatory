...
def main() -> None:
    ...
    try:
        ...
        require("Shadow Search Portfolio · retrospective Paper Design audit" in ideas["text"] and "qualifying query-level units=0" in ideas["text"], "shadow Paper Design/SP-15 support results are not rendered")
