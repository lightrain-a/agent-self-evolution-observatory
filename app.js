...
function renderIdeaPortfolio(config) {
  ...
  return `${pageHeader(config)}${renderArchitectureOverview(pageArchitecture("paper-ideas"))}${renderCustomChapter(chapters[0],0,discussed)}${renderCustomChapter(chapters[1],1,`${newIdeas}${incubation}`)}`;
}
