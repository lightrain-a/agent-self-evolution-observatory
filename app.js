...
function renderExperimentDashboard(config) {
  ...
  const queue = `${renderPreGpuCandidateGateBoard()}${renderPreP0IdentifiabilityPanel()}${renderP0RuntimeReadiness()}${renderP0ExperimentBoard()}`;
