...
function renderIdeaPortfolio(config) {
  ...
  const iclrDecision = `${renderIclrExperimentAudit()}${renderIclrIdeaBank()}${window.renderIdeaDiscoveryV4 ? window.renderIdeaDiscoveryV4() : ""}${window.renderSolutionFirstIdeas ? window.renderSolutionFirstIdeas() : ""}${window.renderMachineSchoolIdeas ? window.renderMachineSchoolIdeas() : ""}`;
