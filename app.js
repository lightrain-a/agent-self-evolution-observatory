...
function renderBibliography(config) {
  ...
  const rankingBody = `<div class="bibliography-reading-analysis-grid">${readingPaths}${analysisGuide}</div>${rankingGuide}`;
