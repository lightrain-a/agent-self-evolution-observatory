...
const PAGE_CITATIONS = {
  ...
  "direction-board": [
    ["Self-Improvements in Modern Agentic Systems: A Survey", "A Survey of Self-Evolving Agents: What, When, How, and Where to Evolve", "Self-evolving Embodied AI"],
    ["VISCO: Benchmarking Fine-Grained Critique and Correction towards Self-Improvement in Visual Reasoning", "EVE-Agent: Evidence-Verifiable Self-Evolving Agents", "Counterfactual Trace Auditing of LLM Agent Skills", "Hidden Forgetting in Continual Multimodal Learning: When Accuracy Survives but Grounding Fails"],
    ["SEA-Eval: A Benchmark for Evaluating Self-Evolving Agents Beyond Episodic Assessment", "EvoMemBench: Benchmarking Agent Memory from a Self-Evolving Perspective", "WorldMemArena: Evaluating Multimodal Agent Memory Through Action-World Interaction"],
    ["MemEye: Visual-Centric Evaluation for Multimodal Agent Memory", "WorldMemArena: Evaluating Multimodal Agent Memory Through Action-World Interaction", "ManimAgent: Self-Evolving Multimodal Agents for Visual Education"],
    ["From Fixed to Free Cameras: Calibration-Free View-Robust Vision-Language-Action Model", "Self-evolving Embodied AI", "World Model Implanting for Test-Time Adaptation of Embodied Agents"],
    ["VASO: Formally Verifiable Self-Evolving Skills for Physical AI Agents", "EvoSkills: Self-Evolving Agent Skills via Co-Evolutionary Verification", "SkillSmith: Co-Evolving Skills and Tools for Self-Improving Agent Systems", "Agent-World: Scaling Real-World Environment Synthesis for Evolving General Agent Intelligence", "SimWorld Studio: Automatic Environment Generation with Evolving Coding Agent for Embodied Agent Learning"],
    ["A Comprehensive Survey of Self-Evolving AI Agents: A New Paradigm Bridging Foundation Models and Lifelong Agentic Systems"],
  ],
  "paper-experiments": [
