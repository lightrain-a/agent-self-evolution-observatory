...
function renderIdeaPortfolio(config) {
  ...
  const iclrDecision = `${renderIclrExperimentAudit()}${renderIclrIdeaBank()}${window.renderSolutionFirstIdeas ? window.renderSolutionFirstIdeas() : ""}${window.renderMachineSchoolIdeas ? window.renderMachineSchoolIdeas() : ""}`;
