...
function renderIdeaPortfolio(config) {
  ...
  const iclrDecision = `${renderIclrExperimentAudit()}${renderIclrIdeaBank()}${window.renderAdvisorPriorityIdeas ? window.renderAdvisorPriorityIdeas() : ""}${window.renderIdeaDiscoveryV5 ? window.renderIdeaDiscoveryV5() : ""}${window.renderIdeaDiscoveryV4 ? window.renderIdeaDiscoveryV4() : ""}${window.renderSolutionFirstIdeas ? window.renderSolutionFirstIdeas() : ""}${window.renderMachineSchoolIdeas ? window.renderMachineSchoolIdeas() : ""}`;
