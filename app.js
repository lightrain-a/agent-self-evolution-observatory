...
function exportBibliography(format) {
  ...
  const fields = ["priorityRank","readingRole","readingRoleRank","publicationTier","citationCount","citationSource","citationMatchedTitle","citationMatchScore","mustReadRank","mustReadReason","mustReadTeam","year","title","venue","category","subcategory","updateTarget","signal","vision","analysisBasis","problemMotivation","comparativeAdvantage","coreIntuition","rationale","methodFlow","experimentalValidation","designComponents","designInputs","designLoop","designArtifact","designAcceptance","url","repo"];
