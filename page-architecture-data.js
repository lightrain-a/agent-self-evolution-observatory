window.PAGE_ARCHITECTURES = {
  ...
  "selected-paper":{
    chapters:[
      {id:"paper-collection-formal",title:{en:"I · Formal PaperRegistry portfolio",zh:"第一章 · 正式 PaperRegistry 论文"},question:{en:"Which five papers are already formal PaperStates, what is each current state, and where should a reader open the full single-paper story?",zh:"哪 5 篇已经进入正式 PaperRegistry、各自当前是什么状态，以及应从哪里进入完整单篇故事？"}},
      {id:"paper-collection-working",title:{en:"II · Working papers and independent scientific objects",zh:"第二章 · 工作论文与独立 Scientific Object"},question:{en:"Which four lines are still working papers or scientific objects, how are they kept distinct from formal publication codes, and what is the next gate for each?",zh:"哪 4 条仍是工作论文或独立 scientific object、怎样与正式论文编号保持区分，以及各自下一道门是什么？"}}
    ]
  },
  bibliography:{
    chapters:[
