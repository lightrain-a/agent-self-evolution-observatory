window.PAGE_ARCHITECTURES = {
  ...
  "system-overview":{
    chapters:[
      {id:"system-map",title:{en:"I · Canonical architecture: one lifecycle + six backend layers",zh:"第一章 · 总体架构：一条主流程 + 六个后端职责层"},question:{en:"What is the single paper-first lifecycle, how do the six responsibility layers implement it, where does the seven-stage P0 sub-machine fit, and which cross-cutting methodology controls guard the whole lifecycle?",zh:"唯一的 Paper-first 主流程是什么、六个职责层如何实现它、P0 的 7-stage 子状态机位于哪里，以及哪些横向方法学控制贯穿整个生命周期？"}},
