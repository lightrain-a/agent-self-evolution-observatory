window.PAGE_ARCHITECTURES = {
  ...
  "selected-paper":{
    chapters:[
      ...
      {id:"paper-d2-paper-proxy-reward-memory-variance",title:{en:"Paper 3 · Noisy Rewards Write Noisy Memories",zh:"论文 3 · 奖励噪声写入记忆"},navTitle:{en:"Reward → Memory",zh:"奖励 → 记忆"},question:{en:"Can a wrong terminal reward label change the persistent memory written from an otherwise identical trajectory, and which downstream effects are still unproven?",zh:"错误的终点 reward 标签能否在 trajectory 完全相同时改变写入的持久 memory？目前哪些更下游的行为效应仍然没有被证明？"}},
