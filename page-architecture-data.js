window.PAGE_ARCHITECTURES = {
  ...
  "selected-paper":{
    chapters:[
      {id:"current-stri",title:{en:"STRI detail · evidence and submission handoff",zh:"STRI 详页 · 证据与投稿交接"},question:{en:"For STRI specifically, which claims are supported, what is explicitly excluded, and what human handoff remains after the portfolio-level PaperRegistry above?",zh:"在上方 PaperRegistry 给出组合状态后，STRI 这一篇具体有哪些主张得到支持、哪些内容明确不主张，以及还剩什么人工交接？"}},
