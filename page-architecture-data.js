window.PAGE_ARCHITECTURES = {
  ...
  "selected-paper":{
    chapters:[
      {id:"current-stri",title:{en:"I · Current selected paper — STRI",zh:"第一章 · 当前选中论文 — STRI"},question:{en:"Where is STRI in the canonical Paper Ledger, which scientific claims are frozen, which Story Search / Mock PC / Claim Audit gates are complete, and what is the next permitted paper-only action?",zh:"STRI 当前处于 canonical Paper Ledger 的哪一步、哪些科学主张已经冻结、Story Search / Mock PC / Claim Audit 三类硬门分别完成到哪里，以及下一项允许的论文工作是什么？"}},
