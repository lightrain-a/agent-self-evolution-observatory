window.PAGE_ARCHITECTURES = {
  ...
  "system-overview":{
    chapters:[
      ...
      {id:"scientific-design",title:{en:"III · Compress the Problem–Insight and design the minimum sufficient intervention",zh:"第三章 · 压缩 Problem–Insight，再设计最小充分干预"},navTitle:{en:"Problem–Insight design",zh:"Problem–Insight 设计"},question:{en:"Before implementation, can we state the important under-explained problem, identify the true contribution layer, derive a minimum sufficient intervention from the insight, and register predictions that distinguish it from the strongest simple explanation?",zh:"实现之前，能否先说清重要但未解释的问题是什么、真正的新贡献落在哪一层、最小充分干预怎样由 Insight 推出，以及哪些预测能区分它和最强简单解释？"}},
      ...
      {id:"paper-construction",title:{en:"VII · Choose the story, build the manuscript, and verify post-draft integrity",zh:"第七章 · 选故事线、形成成稿，再核验成稿完整性"},navTitle:{en:"Story, manuscript & integrity",zh:"故事线、成稿与完整性"},question:{en:"Within the frozen claim set, which story is clearest, and after drafting do all facts, citations, numbers, tables, and claims remain bound to the exact evidence?",zh:"在冻结主张范围内，哪条故事线最清楚？成稿以后，事实、引用、数字、表格和 claim 是否仍逐项绑定到真实证据？"}},

      {id:"review-repair",title:{en:"VIII · Deterministic integrity, independent review, targeted repair, and re-audit",zh:"第八章 · 确定性完整性核验、独立审稿、定向修稿与复核"},navTitle:{en:"Integrity, review & repair",zh:"完整性、审稿与修稿"},question:{en:"Which errors are deterministic artifact inconsistencies, which are genuine reviewer concerns about significance or evidence, and after repair do both integrity and claim boundaries still pass?",zh:"哪些问题是可以确定性发现的事实/数据/引用不一致，哪些是真正关于意义、Insight 或实验充分性的审稿质疑？修完以后完整性和主张边界是否都重新通过？"}},
  ...
  "selected-paper":{
    chapters:[
      {id:"paper-stri",title:{en:"E1 Skills · STRI",zh:"E1 技能 · STRI"},navTitle:{en:"E1 · STRI",zh:"E1 · STRI"},question:{en:"If semantic skill support is unchanged, can repackaging skills alone change self-evolution control, and what exact certificate identifies when that distortion can be removed?",zh:"如果技能的语义支持不变，仅仅重新拆分或分组 skill package 会不会改变自进化控制？什么精确证书能判断这种表示失真何时可被消除？"}},

      {id:"paper-agent-safety",title:{en:"G1 Safety · R9",zh:"G1 安全 · R9"},navTitle:{en:"G1 · R9",zh:"G1 · R9"},question:{en:"Does passing a safety panel now certify a declared future, and what changes when the same future schedule is run with versus without workflow updates?",zh:"Agent 现在通过安全检查，是否能保证声明的未来 horizon 内也不会首次违规？同一未来 schedule 在更新与不更新 workflow 时会有什么差异？"}},

      {id:"paper-d2-paper-proxy-reward-memory-variance",title:{en:"C1 Evaluation · Proxy Reward",zh:"C1 评估 · Proxy Reward"},navTitle:{en:"C1 · Proxy Reward",zh:"C1 · Proxy Reward"},question:{en:"When a reward-conditioned writer changes durable memory on the same trajectory, how far does that difference survive native retrieval, policy uptake, and terminal outcome?",zh:"在同一 trajectory 上 reward-conditioned writer 改变 durable memory 后，这份差异能沿 native retrieval、policy uptake 一直传播到 terminal outcome 的哪一阶段？"}},

      {id:"paper-d2-paper-temporal-skill-causal-bottleneck",title:{en:"E2 Skills · Temporal Attribution",zh:"E2 技能 · Temporal Attribution"},navTitle:{en:"E2 · Temporal Attribution",zh:"E2 · Temporal Attribution"},question:{en:"When a temporal skill appears effective, which part is net repair, same-surface output, placebo/surface perturbation, or integration-surface credit?",zh:"一个 temporal skill 看起来有效时，哪些收益是真正 net repair，哪些来自 same-surface output、placebo/surface perturbation 或 integration-surface credit？"}},

      {id:"paper-d2-paper-failure-memory-provenance",title:{en:"B1 Memory · Provenance Ladder",zh:"B1 记忆 · Provenance Ladder"},navTitle:{en:"B1 · Provenance Ladder",zh:"B1 · Provenance Ladder"},question:{en:"Which provenance channel is actually identified: observational association, outcome-conditioned writer mode, byte-identical metadata-only provenance, or source-faithful transport—and why does the current evidence leave the provenance-only causal sign unresolved?",zh:"当前证据究竟识别了哪一层 provenance channel：观察关联、outcome-conditioned writer mode、byte-identical metadata-only provenance，还是 source-faithful transport？为什么现有证据仍必须把 provenance-only causal sign 保持为 unresolved？"}}
    ],
    archiveChapters:[
