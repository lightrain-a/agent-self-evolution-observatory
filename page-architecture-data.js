window.PAGE_ARCHITECTURES = {
  ...
  "system-overview":{
    chapters:[
      ...
      {id:"economy-compile",title:{en:"III · P0 Economy, protocol validity, and experiment compilation",zh:"第三章 · P0 经济门、协议有效性与实验启动前编译"},question:{en:"How does the system reject reducible, unsupported, protocol-invalid, mis-specified, or low-VOI experiments before expensive execution?",zh:"系统如何在昂贵执行前淘汰可约简、底座不足、评测协议无效、建模错误或低 VOI 的实验？"}},
