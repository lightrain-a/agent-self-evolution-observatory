window.PAGE_ARCHITECTURES = {
  ...
  "research-map":{
    chapters:[
      ...
      {id:"integrated-map",title:{en:"III · Formal publication lineage first, then each A–G research story",zh:"第三章 · 先看正式发表论文的发展主线，再读每个 A–G 研究故事"},question:{en:"How did formally published work develop over time, and for each A–G category where do our work and the public literature now stand?",zh:"先按年份看正式会议/期刊论文怎样一步步形成当前研究版图，再进入每个 A–G 方向比较我们做到哪里、别人做到哪里，以及为什么形成今天的结论。"}},
