window.PAGE_ARCHITECTURES = {
  ...
  "research-map":{
    chapters:[
      ...
      {id:"integrated-map",title:{en:"III · Read each A–G area as a research story",zh:"第三章 · 把每个 A–G 方向读成一条研究故事"},question:{en:"For each category, what is the problem, where does our work stand, what has neighboring work established, and why did the evidence lead to the current decision?",zh:"对每个 A–G 方向，先看它在问什么，再看我们做到哪里、别人做到哪里，以及证据为什么把我们带到今天这个结论。"}},
  ...
  "selected-paper":{
    chapters:[
      {id:"current-stri",title:{en:"I · Current STRI PaperState",zh:"第一章 · 当前 STRI PaperState"},question:{en:"Which claims already have evidence, what remains excluded, which Paper Acceptance gate is current, and what must happen before true Submission Ready?",zh:"STRI 哪些主张已经有证据、哪些更宽结论仍明确排除、当前处于哪个 Paper Acceptance 门禁，以及真正 Submission Ready 前还必须完成什么？"}},
