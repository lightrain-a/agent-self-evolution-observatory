window.PAGE_ARCHITECTURES = {
  ...
  "system-overview":{
    chapters:[
      ...
      {id:"problem-discovery",title:{en:"II · Discover a real scientific problem",zh:"第二章 · 发现真实科学问题"},question:{en:"How does measured primary evidence survive closest-work, mature-theory reduction, and the Problem Gate before any method is proposed?",zh:"真实 measured evidence 如何经过最近邻工作、成熟理论 reduction 与 Problem Gate，之后才允许进入方法设计？"}},
      {id:"paper-design",title:{en:"III · Design the paper before implementation",zh:"第三章 · 实现之前先把论文设计完整"},question:{en:"How are novelty, principle, method, baselines, ablations, analyses, and visual evidence frozen before a pilot can influence implementation?",zh:"Novelty、原理、方法、Baseline、消融、分析和 Visual Evidence 如何在 pilot 影响实现之前就被冻结？"}},
      {id:"experiment-compile",title:{en:"IV · Compile the cheapest decisive experiment",zh:"第四章 · 编译最便宜的决定性实验"},question:{en:"How do Economy, Protocol Validity, Updater Competence, REP, and the eight gates decide whether a local run deserves resources?",zh:"Economy、Protocol Validity、Updater Competence、REP 和 8 Gate 如何共同决定一个局部实验是否值得消耗资源？"}},
      ...
      {id:"paper-evidence",title:{en:"VI · Close paper evidence and release",zh:"第六章 · 论文证据闭环与发布"},question:{en:"How do claim-matched baselines, ablations, analyses, figures, reproducibility, content-addressed receipts, venue QA, and human signoff become one release package?",zh:"与主张匹配的 Baseline、消融、分析、图表、复现、content-addressed receipt、会议 QA 与人工签字如何形成一个发布包？"}},
      {id:"system-learning",title:{en:"VII · Turn outcomes into system memory",zh:"第七章 · 把科研结果沉淀成系统记忆"},question:{en:"How do decisions become Meta-Trace state, Failure Assets, replay-tested rules, external-system learning, and public snapshots without rewriting history?",zh:"科研决策如何变成 Meta-Trace、Failure Assets、回放验证规则、外部系统学习与公开快照，同时不改写科研历史？"}}
    ]
  },
  "research-directions":{
    chapters:[
