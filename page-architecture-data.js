window.PAGE_ARCHITECTURES = {
  ...
  "selected-paper":{
    chapters:[
      ...
      {id:"paper-d2-paper-proxy-reward-memory-variance",title:{en:"Paper 3 · Noisy Rewards Write Noisy Memories",zh:"论文 3 · 奖励噪声写入记忆"},navTitle:{en:"Reward → Memory",zh:"奖励 → 记忆"},question:{en:"How far has the reward-conditioned memory-writing paper advanced, and which downstream variance evidence remains bounded by its canonical ledger?",zh:"奖励条件化记忆写入这篇论文推进到哪里，哪些下游方差证据仍受 canonical ledger 的边界约束？"}},
      {id:"paper-d2-paper-temporal-skill-causal-bottleneck",title:{en:"Paper 4 · Temporal Skill Causal Bottleneck",zh:"论文 4 · 时间技能因果瓶颈"},navTitle:{en:"Temporal Skills",zh:"时间技能"},question:{en:"What is submission-ready in the TimeSage paper, what external first-party support is still missing, and why does that debt not alter the frozen scientific object?",zh:"TimeSage 论文哪些工件已经投稿就绪、还缺什么一方支持，以及为什么这项证据债不改变冻结的科学对象？"}},
      {id:"paper-d2-paper-failure-memory-provenance",title:{en:"Paper 5 · Failure-Memory Provenance",zh:"论文 5 · 失败记忆来源"},navTitle:{en:"Failure Provenance",zh:"失败来源"},question:{en:"Which provenance claims are already supported, which matched swap remains blocked, and what exactly keeps this paper in Targeted Repair?",zh:"失败记忆来源论文哪些主张已有支持、哪项 matched swap 仍被阻塞，以及是什么让它继续停在 Targeted Repair？"}}
    ],
    archiveChapters:[
  ...
  bibliography:{
    chapters:[
      ...
      {id:"field-maps",title:{en:"III · Use the full corpus maps only after the published spine is clear",zh:"第三章 · 正式主线看清以后，再看完整语料的领域分布"},question:{en:"Where is the complete corpus dense by year, update surface, feedback signal, and publication type, including the preprint frontier?",zh:"把预印本前沿也放回来以后，按年份、更新对象、反馈信号和发表类型看，完整语料主要集中在哪里？"}},
      {id:"search-corpus",title:{en:"IV · Search the complete library, including the preprint frontier",zh:"第四章 · 检索全部文献，包括预印本前沿"},question:{en:"How can readers locate, filter, compare, cite, and export exactly the published or frontier records they need?",zh:"怎样定位、筛选、比较、引用和导出真正需要的正式论文或前沿预印本？"}},
      {id:"coverage-protocol",title:{en:"V · Finally audit corpus provenance, coverage, and trust",zh:"第五章 · 最后检查语料来源、覆盖范围与可信度"},question:{en:"Which sources feed the corpus, how are duplicate versions merged, and which fields are manually verified versus automatically derived?",zh:"这份文献库由哪些来源组成、重复版本怎样合并，以及哪些内容经过人工核验、哪些只是自动归纳？"},sourceIds:["coverage-method"]}
    ]
  }
};
