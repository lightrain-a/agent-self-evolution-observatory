(() => {
  ...
  const paperCard = (paper, index) => {
    const prep=paper.paper_preparation||{}, freeze=paper.submission_freeze||{}, handoff=paper.submission_handoff||{}, gates=paper.gates||{}, layers=paper.layers||{};
