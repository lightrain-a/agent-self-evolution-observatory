...
def main() -> None:
    ...
    def persist(status: str, **extra: Any) -> None:
        payload = {"schema_version": "ace-sq0-v5-mcp-progress-v1", "case_id": args.case_id, "task_id": args.task_id, "status": status,
    ...
    try:
        for line in sys.stdin:
            ...
            if method == "initialize":
                ...
                _send({"jsonrpc":"2.0","id":rid,"result":{"protocolVersion":MCP_PROTOCOL_VERSION,"capabilities":{"tools":{}},"serverInfo":{"name":"ace-sq0-v5-appworld","version":"1.0"},"instructions":"Use only these AppWorld tools to complete the target-local SQ0-V5 task. Do not use host tools."}})
