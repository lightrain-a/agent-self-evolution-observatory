...
class ResearchSystemTest(unittest.TestCase):
    ...
    def test_reference_components_are_explicit(self) -> None:
        ...
        self.assertEqual(len(self.state["components"]), 34)
        ...
        self.assertEqual(architecture["summary"]["assigned_components"], 34)
        ...
        self.assertEqual(len({item["key"] for item in self.state["components"]}), 34)
