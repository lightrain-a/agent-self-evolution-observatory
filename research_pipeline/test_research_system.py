...
class ResearchSystemTest(unittest.TestCase):
    ...
    def test_reference_components_are_explicit(self) -> None:
        ...
        self.assertEqual((self.state["summary"]["paper_first_fresh_drafts_reviewed"],self.state["summary"]["paper_first_fresh_survivors"],self.state["summary"]["paper_first_fresh_stopped"]),(40,0,40))
