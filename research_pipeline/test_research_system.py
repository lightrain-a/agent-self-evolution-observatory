...
class ResearchSystemTest(unittest.TestCase):
    ...
    def test_asset_first_stri_projection_cannot_roll_back_canonical_paper_state(self) -> None:
        ...
        self.assertEqual(self.state["summary"]["asset_first_stri_paper_quality_content_addressed_files"],32)
