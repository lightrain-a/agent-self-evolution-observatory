...
class ResearchSystemTest(unittest.TestCase):
    ...
    def test_state_is_valid_and_iclr_first(self) -> None:
        ...
        self.assertEqual(self.state["summary"]["discussion_ready"], 31)
    ...
    def test_pre_experiment_compiler_is_eight_gate_and_launch_authoritative(self) -> None:
        ...
        self.assertEqual(compiler["summary"]["compiled_cards"], 8)
        self.assertEqual(compiler["summary"]["paper_design_pass"], 4)
        self.assertEqual(compiler["summary"]["paper_design_blocked"], 4)
        self.assertEqual(compiler["summary"]["execution_ready"], 2)
        self.assertEqual(compiler["summary"]["blocked"], 6)
        self.assertEqual(compiler["summary"]["formal_p0_ready"], 2)
        self.assertEqual(compiler["summary"]["formal_p0_total"], 6)
        self.assertEqual(compiler["summary"]["updater_prerequisite_pass"], 2)
        self.assertEqual(compiler["summary"]["updater_prerequisite_fail"], 6)
        self.assertEqual(compiler["summary"]["research_execution_plans"], 8)
    ...
    def test_reference_components_are_explicit(self) -> None:
        ...
        self.assertEqual(self.state["summary"]["p0_admission_active"], 31)
        self.assertEqual(self.state["summary"]["p0_admission_transitioned"], 16)
        self.assertEqual(self.state["summary"]["p0_admission_settings_complete"], 31)
        self.assertEqual(self.state["summary"]["p0_admission_economy_ready"], 2)
        ...
        self.assertEqual(self.state["summary"]["paper_first_p0_promoted"], 4)
