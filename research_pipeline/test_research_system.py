...
class ResearchSystemTest(unittest.TestCase):
    ...
    def test_reference_components_are_explicit(self) -> None:
        ...
        self.assertEqual(len(self.state["components"]), 19)
        ...
        self.assertEqual(self.state["summary"]["p0_economy_matched_simplification_stops"], 16)
        self.assertEqual(self.state["summary"]["p0_economy_substrate_stops"], 7)
        ...
        self.assertEqual((self.state["summary"]["p0_batch_matched_stops"],self.state["summary"]["p0_batch_upstream_holds"],self.state["summary"]["p0_batch_gpu_candidates"]),(4,3,0))
