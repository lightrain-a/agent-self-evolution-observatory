    ...
    return {
        ...
        "shared_p0": {
            ...
            "signal_stage": {
                ...
                "snapshot_semantics": "Launch metadata is durable; measured progress/results are published only after the run writes complete typed artifacts.",
            },
            "next_gate": "The shared 24-execution three-arm signal stage is launched on the qualified Qwen2.5-7B-Instruct substrate. Open the full Qwen treatment table only if the frozen signal gate observes sufficient arm outcome disagreement.",
        }
    }
