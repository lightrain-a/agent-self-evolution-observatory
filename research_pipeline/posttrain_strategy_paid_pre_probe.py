...
EXPECTED_CONTRACT_SHA256 = "dc5df317551a7f5773d3e6d5bf11aff34f202b1600a81dd019ba62ce66ff7a12"
EXPECTED_AUTH_SHA256 = "f096bf05e2d1d8d52be277fd2533435346e8760b8079948832486133a4570d2e"
...
def _validate_frozen_inputs(repo_root: Path) -> dict[str, Any]:
    paths = {
        "contract": repo_root / "generated/v19r003-forced-switch-deepseek-pre-contract-r2-20260824.json",
        "authorization": repo_root / "generated/v19r003-forced-switch-deepseek-pre-authorization-r1-20260824.json",
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Authorized paid DeepSeek PRE_STRATEGY probe for V19R-003")
    ...
    receipt_path = run_dir / "paid-pre-receipt.json"
    ...
    base_receipt: dict[str, Any] = {
        "schema_version": "1.0-v19r003-paid-pre-r1",
        "artifact_kind": "V19R003_DEEPSEEK_PRE_STRATEGY_PAID_RESULT_R1",
    ...
    try:
        result = run_deepseek_tool_loop(
            ...
            budget=AgentLoopBudget(max_provider_calls=4, max_output_tokens_per_call=512, max_reported_output_tokens=2048),
            model=MODEL,
        )
