...
def _latest_shadow_run(root:Path)->dict:
    ...
    source_generated_at=str(qualification.get('source_generated_at') or frozen.get('generated_at') or '');source_set_sha=str(qualification.get('source_set_sha256') or frozen.get('source_set_sha256') or '');source_pool_sha=str(qualification.get('source_pool_sha256') or frozen.get('source_pool_sha256') or '')
