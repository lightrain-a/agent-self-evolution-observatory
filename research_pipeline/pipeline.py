...
from .final_advisor_audit import build_final_advisor_audit
...
def build_snapshot(
    ...
    final_audit = build_final_advisor_audit()
    final_discussion_count = int((final_audit.get("summary") or {}).get("pass") or 0)
