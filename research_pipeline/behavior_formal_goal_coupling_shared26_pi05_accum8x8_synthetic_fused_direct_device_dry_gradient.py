...
def main() -> int:
    ...
    if authority.get("status") != "AUTHORIZED_PI05_SYNTHETIC_FUSED_ACCUM8X8_DIRECT_DEVICE_NO_UPDATE_GATE":
    ...
    initial = {
        ...
        "status": "PI05_SYNTHETIC_FUSED_ACCUM8X8_DIRECT_DEVICE_STARTED",
    ...
    lock_path = Path("/data/wyt/.formal-goal-pi05-synthetic-fused-accum8x8-direct-device.lock")
    with exclusive_lock(lock_path):
        write_receipt(receipt_path, initial)
        status = "PI05_SYNTHETIC_FUSED_ACCUM8X8_DIRECT_DEVICE_HOLD"
        error = None
        state_ready = False
        done = 0
        accumulator = None
        ...
        try:
            ...
            for index in range(K):
                ...
                progress.update(
                    {
                        "status": "PI05_SYNTHETIC_FUSED_ACCUM8X8_MICRO_GRADIENT_STARTED",
            ...
            status = "PI05_SYNTHETIC_FUSED_ACCUM8X8_DIRECT_DEVICE_PASS"
