"""Outcome-blind adjudication for the fresh P1 Q2 implementation qualification."""
...
OUTPUT = ROOT / "generated/asset-first-stri-reasoningbank-p1-q2-adjudication-20260830.json"
...
def adjudicate(
    *, index_path: Path = INDEX, output: Path = OUTPUT,
    ...
    if output.exists():
        raise RuntimeError(f"refusing to overwrite immutable Q2 adjudication: {output}")
    ...
    for receipt in completed:
        ...
        if not path.is_relative_to(ROOT.resolve()):
            raise RuntimeError("Q2 run path escapes repository")
    ...
    qualification_checks = {
        ...
        "runtime_qualification_exact_and_passed": (
            ...
            and runtime["decision"] == "P1_Q2_RUNTIME_QUALIFIED"
            and runtime["scientific_boundary"]["q2_task_outcome_observed"] is False
        ),
    ...
    decision = (
        "P1_Q2_IMPLEMENTATION_QUALIFIED_FULL_P1_PLANNING_GATE_OPEN_EXECUTION_UNAUTHORIZED"
        if implementation_qualified
        else "P1_Q2_IMPLEMENTATION_UNQUALIFIED_FULL_P1_HOLD"
    )
    payload = {
        "schema_version": 1,
        "experiment_id": "E1-STRI-REASONINGBANK-P1-Q2-ADJUDICATION-20260830",
        ...
        "scientific_boundary": {
            ...
            "q2_is_prospective_implementation_qualification_only": True,
