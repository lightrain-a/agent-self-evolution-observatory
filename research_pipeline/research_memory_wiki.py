...
def build_research_memory_wiki(*,search_design_state:dict,failure_asset_library:dict,scientific_meta_trace:dict,candidate_portfolio:dict,experiment_iteration:dict,generator_state:dict,claim_ledger:list[dict]|None=None,supplemental_entries:list[dict]|None=None,generated_at:str|None=None)->dict:
 ...
 for row in supplemental_entries or []:
  if not isinstance(row,dict):continue
  item=dict(row);item["scientific_authority"]=False;entries.append(item)
