...
def _expansion_prompt(lane,records,count,dead_end_memory=None):
    ...
    shape={"seeds":[{
        ...
        "empirical_evidence":{"source_a":{"ref":"arXiv:...","claim":"grounded claim","evidence_role":contract["source_roles"][0]},"source_b":{"ref":"arXiv:...","claim":"grounded claim","evidence_role":contract["source_roles"][1]},"relation":"why the evidence instantiates this lane"},
...
def _formulation_prompt(branches,registry,dead_end_memory=None):
    ...
    return (
        ...
        "Use matched_patterns ONLY for a proven exact hard reduction. Use pending_patterns when an exact reduction test is still unresolved; these will block Problem Gate until resolved. Use rejected_patterns when a broad ledger pattern was considered but cannot exactly reduce the candidate. "
