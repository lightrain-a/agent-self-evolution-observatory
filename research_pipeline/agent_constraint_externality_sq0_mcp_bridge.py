...
from research_pipeline.agent_constraint_externality_sq0_build import load_cases, materialize_case
...
def main() -> None:
    ...
    def persist(status: str, **extra: Any) -> None:
        payload = {"schema_version": "ace-sq0-mcp-progress-v1", "case_id": args.case_id, "task_id": args.task_id, "status": status,
    ...
    try:
        for line in sys.stdin:
            ...
            if method == "initialize":
                ...
                _send({"jsonrpc":"2.0","id":rid,"result":{"protocolVersion":MCP_PROTOCOL_VERSION,"capabilities":{"tools":{}},"serverInfo":{"name":"ace-sq0-appworld","version":"1.0"},"instructions":"Use only these AppWorld tools to complete the target-local SQ0 task. Do not use host tools."}})
