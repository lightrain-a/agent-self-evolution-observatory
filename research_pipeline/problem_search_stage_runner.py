...
from .paper_first_problem_search_portfolio import (
    ...
    _fresh_phenomenon_priors,_inversion_asset_records,_positive_residual_asset_records,_search_asset_records,_maxmin_select,_normalize_seed,_score,_semantic_dedup,_source_refs,_valid_seed,
)
