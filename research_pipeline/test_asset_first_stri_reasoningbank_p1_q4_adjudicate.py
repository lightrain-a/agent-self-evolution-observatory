...
from research_pipeline.asset_first_stri_reasoningbank_p1_q4_adjudicate import (
    paired_invariants,
    summarize_run,
)
...
def synthetic_run(*, resolved: bool, content: str = "task") -> dict:
    return {
        ...
        "runtime": {
            ...
            "receipt": {"base_commit_receipt": {
                "returncode": 0,
                "rule": "exact_base_after_preregistered_hard_reset",
                "expected_base_commit": "a" * 40,
                "observed_head": "a" * 40,
                "pre_normalization": {"returncode": 0},
                "normalization": {"returncode": 0},
...
class ReasoningBankP1Q4AdjudicationTest(unittest.TestCase):
