...
def main() -> int:
    ...
    if authority.get("status") != "AUTHORIZED_PI05_SOURCE_NATIVE_09_COMPILE_ONLY_MEMORY_PROBE_V5A":
    ...
    receipt = {
        "schema_version": "behavior-formal-goal-coupling-shared26-pi05-source-train-compile-probe-v5a-result-v1",
        "object_id": OBJECT_ID,
