...
POLICY: dict[str, Any] = {
    ...
    "internal_research_skill_route_is_frozen_inside_execution_plan": True,
    "missing_declared_internal_skill_is_capability_hold_not_scientific_negative": True,
    "internal_skill_route_cannot_authorize_execution": True,
