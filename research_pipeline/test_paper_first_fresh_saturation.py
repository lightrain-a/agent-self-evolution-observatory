...
class PaperFirstFreshSaturationTest(unittest.TestCase):
    ...
    def test_current_scan_keeps_zero_survivors_instead_of_forcing_shortlist(self) -> None:
        ...
        self.assertEqual((s["drafts_reviewed"],s["survivors"],s["stopped"]),(36,0,36))
