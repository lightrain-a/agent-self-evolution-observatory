...
class FreshSupportTest(unittest.TestCase):
    def fixture(self, root: Path) -> Path:
        ...
        d={
            ...
            'browser_runtime_adapter':{'type':'PLAYWRIGHT_EXACT_EXTERNAL_REQUEST_ABORT_SET','urls':['https://picsum.photos/48','https://picsum.photos/48?random=1','https://kit.fontawesome.com/a076d05399.js','https://twitter.com/compose/twitter-logo.png'],'pinned_twitter_html_sha256':'63cfe828edac802957401a353de3bdcf92518d565c4ec229cb6fcfe87407a45d','pinned_hbb_task_py_sha256':'8796d13e900d01e0fe6c60d446b534b51397711f213e57030f094a9f8358a65a','html_modified':False,'task_config_modified':False,'local_dom_modified':False,'probe_specific':False},
