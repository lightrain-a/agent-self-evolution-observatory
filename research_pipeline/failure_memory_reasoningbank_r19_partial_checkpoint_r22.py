#!/usr/bin/env python3
"""Create a no-interim-inference checkpoint for an incomplete B1/R19 prefix."""
...
def build(run_root: Path) -> dict:
    ...
    return {
        ...
        "receipt_id":"D2-FAILURE-MEMORY-PROVENANCE-L2B-R19-PARTIAL-CHECKPOINT-R22",
        "recorded_at":now(),
...
def main() -> None:
    ...
    p.add_argument("--output",type=Path,default=Path("generated/d2-failure-memory-provenance-l2b-r19-partial-checkpoint-r22.json"))
    a=p.parse_args()
