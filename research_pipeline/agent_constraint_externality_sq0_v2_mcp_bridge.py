...
from research_pipeline.agent_constraint_externality_sq0_v2_build import load_cases
...
def main() -> None:
    ...
    def persist(status: str, **extra: Any) -> None:
        payload = {"schema_version": "ace-sq0-v2-mcp-progress-v1", "case_id": args.case_id, "task_id": args.task_id, "status": status,
    ...
    try:
        for line in sys.stdin:
            ...
            if method == "initialize":
                ...
                _send({"jsonrpc":"2.0","id":rid,"result":{"protocolVersion":MCP_PROTOCOL_VERSION,"capabilities":{"tools":{}},"serverInfo":{"name":"ace-sq0-v2-appworld","version":"1.0"},"instructions":"Use only these AppWorld tools to complete the target-local SQ0-V2 task. Do not use host tools."}})
