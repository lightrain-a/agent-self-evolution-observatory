...
def validate_state(state: dict[str, Any]) -> list[str]:
    ...
    if methodology_summary.get("registered_reviewer_gates") != 6 or methodology_summary.get("c1_reviewer_gate_loaded") is not True: errors.append("C1 executable-closure reviewer gates must be registered and bound to the versioned revision program")
    if methodology_summary.get("c1_reviewer_gate_d0_design_eligible") is not True: errors.append("C1 revision program must pass the fail-closed executable-closure gate before D0 design work")
