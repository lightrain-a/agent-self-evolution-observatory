...
def validate_state(state: dict[str, Any]) -> list[str]:
    ...
    if methodology_summary.get("registered_reviewer_gates") != 1 or methodology_summary.get("c1_reviewer_gate_loaded") is not True: errors.append("C1 executable-closure reviewer gate must be registered and bound to the versioned revision program")
