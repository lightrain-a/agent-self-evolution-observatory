...
def validate_state(state: dict[str, Any]) -> list[str]:
    ...
    if methodology_summary.get("controls") != 4 or methodology_summary.get("primary_components_added") != 0 or methodology_summary.get("functional_layers_added") != 0: errors.append("cross-cutting methodology controls must add four controls without new primary components or layers")
    ...
    if architecture_summary.get("cross_cutting_controls") != 4 or architecture_summary.get("orphan_cross_cutting_controls") != 0: errors.append("all cross-cutting methodology controls must resolve to an existing owner component")
