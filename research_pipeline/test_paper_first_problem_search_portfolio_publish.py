...
class SearchPortfolioPublishTest(unittest.TestCase):
    ...
    def test_latest_terminal_run_is_appended_without_erasing_historical_shadow(self) -> None:
        with tempfile.TemporaryDirectory() as td:
            ...
            (run/"shadow-final-audit.json").write_text(json.dumps({"rows":[{"candidate_id":"S1","title":"blocked one","search_primitive":"UNEXPLAINED_BOUNDARY","shadow_clear":False,"candidate":{"empirical_evidence":{"source_a":{"ref":"arXiv:2608.11350"},"source_b":{"ref":"arXiv:2608.11350"}},"semantic_reduction_review":{"verdict":"BLOCK","reduction_class":"NEEDS_EXACT_REDUCTION_TEST","lane_contract_verified":True,"matched_patterns":["persistent-update-vs-test-time-compute"],"strongest_reduction":"generic test-time scaling","exact_reduction_test":"match candidate quality and diversity","reason":"exact reduction remains unresolved","lane_contract_reason":"lane valid"}}},{"candidate_id":"S2","title":"blocked two","search_primitive":"CONVERGENT_FAILURE","shadow_clear":False,"candidate":{"empirical_evidence":{"source_a":{"ref":"arXiv:2608.09629"},"source_b":{"ref":"arXiv:2608.11340"}},"semantic_reduction_review":{"verdict":"BLOCK","reduction_class":"SOFT_COLLISION","lane_contract_verified":False,"matched_patterns":["model-scaffold-enactability"],"strongest_reduction":"cross-model instruction compatibility","exact_reduction_test":"hold budget fixed","reason":"lane contract fails","lane_contract_reason":"no shared bounded condition"}}},{"candidate_id":"S3","title":"semantic clear","search_primitive":"IDENTIFIABILITY_GAP","shadow_clear":True,"candidate":{"empirical_evidence":{"source_a":{"ref":"arXiv:2608.09168"}},"semantic_reduction_review":{"verdict":"CLEAR","reduction_class":"NONE","lane_contract_verified":True}}}]}),encoding="utf-8")
