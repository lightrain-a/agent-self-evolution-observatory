...
def build() -> dict[str, Any]:
    required = [MAIN, BODY, BIB, PDF, FIG, SYNTHESIS, P0, P1, P2, NOVELTY, PREVALENCE, SECOND, R19_STOP]
    ...
    closure = {
        ...
        "strongest_reduction": all(x in body.lower() for x in ("strategic replication", "action-redundancy", "homomorphism")),
        ...
        "phase_prediction": all(x in body for x in ("M\\le N<kM", "$(k-1)M$", "882")),
    ...
    manuscript = {
        ...
        "uncited_new_mechanism_sources_present": all(k in bib_keys for k in ("liu2026rethinkskill", "shin2022replication", "baram2021redundancy", "ravindran2004approximate")),
