...
def main() -> int:
    ...
    payload = {
        ...
        "status": "PI05_ACCUM_8X8_DATA_ORDER_QUALIFICATION_PASS" if all_equal and not reaches_epoch_boundary else "PI05_ACCUM_8X8_DATA_ORDER_QUALIFICATION_HOLD",
        ...
        "next_gate": "ACCUM8X8_NO_UPDATE_DRY_GRADIENT_RESOURCE_QUALIFICATION" if all_equal and not reaches_epoch_boundary else "DATA_ORDER_REPAIR_ADJUDICATION",
    }
