#!/usr/bin/env python3
"""Create the R24 no-interim-inference checkpoint for an incomplete B1/R19 prefix."""
...
RECEIPT_ID = "D2-FAILURE-MEMORY-PROVENANCE-L2B-R19-PARTIAL-CHECKPOINT-R24"
...
def main() -> None:
    ...
    p.add_argument("--output", type=Path, default=Path("generated/d2-failure-memory-provenance-l2b-r19-partial-checkpoint-r24.json"))
    a = p.parse_args()
