...
class PaperFirstProblemDiscoveryContractTest(unittest.TestCase):
    def test_contract_keeps_four_final_lanes_but_enables_canonical_double_funnel(self) -> None:
        ...
        self.assertTrue(policy["search_closure_exact_source_reentry_forbidden"])
        self.assertTrue(policy["search_closure_reopen_requires_new_evidence"])
        self.assertTrue(policy["reopenable_support_hold_search_prior_enabled"])
        self.assertTrue(policy["support_stop_is_not_search_closure"])
        self.assertTrue(policy["support_hold_revisit_requires_reopen_evidence"])
        self.assertTrue(policy["support_hold_missing_support_is_not_scientific_negative"])
