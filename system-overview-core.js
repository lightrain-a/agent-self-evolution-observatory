  ...
  api.renderPurpose = function renderPurpose(state, s2) {
    ...
    return `<section class="system-hero system-section">
      ...
      <div class="system-stat-grid system-hero-stats">
        ...
        ${stat(get(pilot.valid_result_files,0),"个有效 Pilot 结果","valid pilot results")}
        ${stat(get(pilot.invalid_result_files,0),"个被拒绝/作废结果","rejected or invalidated results",get(pilot.invalid_result_files,0)?"warn":"")}
      </div>
    </section>
