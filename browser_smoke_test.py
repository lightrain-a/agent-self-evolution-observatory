...
def main() -> None:
    ...
    try:
        ...
        expected_signoff_pending = sum((p.get("submission_handoff") or {}).get("status") == "MACHINE_HANDOFF_READY_HUMAN_CONFIRMATION_REQUIRED" and (p.get("human_signoff") or {}).get("status") == "PENDING_HUMAN_CONFIRMATION" for p in registry_papers)
