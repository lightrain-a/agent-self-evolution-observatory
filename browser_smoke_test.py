...
def main() -> None:
    ...
    try:
        ...
        require("PaperRegistry" in selected["title"] and "PaperRegistry" in selected["text"] and "SUBMISSION_READY" in selected["text"] and "AGENT-SAFETY-R9" in selected["text"] and "CAUSAL_HOLD" in selected["text"] and "2026-09-18" in selected["text"] and "2026-09-25" in selected["text"] and ("Former Regression-Gated Self-Evolution workspace" in selected["text"] or "旧 Regression-Gated Self-Evolution 工作区" in selected["text"]), f"selected-paper PaperRegistry/current/historical hierarchy is wrong: {selected}")
