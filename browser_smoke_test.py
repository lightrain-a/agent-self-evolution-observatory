...
def main() -> None:
    ...
    try:
        ...
        require(system_overview["stages"] == 12 and system_overview["stats"] == 9, "system data flow or live statistics are incomplete")
        require(system_overview["layers"] == 7 and system_overview["contracts"] == 12, "backend layers or stage data contracts are incomplete")
