...
def main() -> None:
    ...
    try:
        ...
        require(system_overview["memorySummary"].get("entries") >= 50 and system_overview["memorySummary"].get("scientific_closures") == 1 and system_overview["memorySummary"].get("failure_assets") >= 3 and system_overview["memorySummary"].get("success_assets") >= 3 and system_overview["memoryLint"].get("errors") == 0, f"Research Memory Wiki state is missing or invalid: summary={system_overview['memorySummary']} lint={system_overview['memoryLint']}")
