...
def main() -> None:
    ...
    try:
        ...
        require(set(selected["submissionDownloads"]) == {"downloads/STRI-ICLR2027.pdf","downloads/STRI-ICLR2027-source.zip"}, f"selected-paper STRI stable downloads are stale: {selected['submissionDownloads']}")
        require(set(selected["agentSafetyDownloads"]) == {"downloads/Agent-Safety-R9.pdf","downloads/Agent-Safety-R9-source.zip"}, f"selected-paper Agent Safety stable downloads are stale: {selected['agentSafetyDownloads']}")
