    ...
    try:
        ...
        for page, expected in EXPECTATIONS.items():
            ...
            if page == "experiment-costs":
                ...
                if costs.get("sections") != 3 or costs.get("tables") != 1 or costs.get("rows") != 11 or costs.get("facts") != 3 or len(costs.get("toc", [])) != 3 or costs.get("status") != 0 or costs.get("overflow"):
