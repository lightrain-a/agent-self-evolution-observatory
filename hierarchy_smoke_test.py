    ...
    try:
        ...
        for page, expected in EXPECTATIONS.items():
            ...
            if page == "experiment-costs":
                ...
                if costs.get("sections") != 4 or costs.get("tables") != 2 or costs.get("rows") != 11 or costs.get("facts") != 7 or len(costs.get("toc", [])) != 4 or costs.get("status") != 0 or costs.get("overflow"):
