(() => {
  ...
  pages["selected-paper"] = {
    ...
    callout:{en:"All five current PaperStates have passed the internal paper-quality gates, but that does not make their scientific evidence equally decisive. For example, Temporal Skills has direct three-arm source-native causal evidence with explicit negative boundaries, while Failure-Memory Provenance has a strong motivating association but an unresolved matched-swap causal sign. None of the five has been submitted automatically; real submission remains a human-author action.",zh:"当前 5 篇 PaperState 都已通过内部论文质量门，但这不代表 5 篇的科学证据同样强。例如 Temporal Skills 已有三臂 source-native 因果证据并明确报告负边界；Failure-Memory Provenance 则是动机性关联很强、matched-swap 的 causal sign 仍未决。5 篇都不会被系统自动投稿，真实提交仍由作者人工完成。"},
