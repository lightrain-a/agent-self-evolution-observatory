...
def main() -> None:
    ...
    if shadow_portfolio.get("latest_run_id") != "shadow-20260814-r5" or (latest_summary.get("requested_raw_seeds"),latest_summary.get("expansion_successful_shards"),latest_summary.get("expansion_execution_failures"),latest_summary.get("raw_seeds"),latest_summary.get("semantic_unique"),latest_summary.get("evolved_branches"),latest_summary.get("formulation_successful_shards"),latest_summary.get("formulation_parse_failures"),latest_summary.get("formulation_successful_branches"),latest_summary.get("formulation_execution_censored_branches"),latest_summary.get("formulated_candidates"),latest_summary.get("machine_reviewable"),latest_summary.get("problem_falsifier_eligible"),latest_summary.get("semantic_clear"),latest_summary.get("terminal_shadow_survivors")) != (120,18,2,84,47,36,11,1,22,2,14,0,0,0,0):
        fail(f"latest Search Portfolio r5 funnel/accounting is stale: {latest_shadow}")
    ...
    if shadow_queue.get("latest_run_id") != "shadow-20260814-r5" or latest_queue_summary.get("terminal_shadow_survivors") != 0 or latest_queue_summary.get("live_paper_design_eligible") != 0:
