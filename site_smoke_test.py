...
def main() -> None:
    ...
    expected_dispositions = {"RESOLVED":10,"EXISTING_EVIDENCE_ACTIONABLE":6,"REQUIRES_SCIENTIFIC_REOPEN":9,"PERMANENT_CLAIM_BOUNDARY":8}
