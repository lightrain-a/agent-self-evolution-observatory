...
ROOT = HERE.parents[1]
REGISTRY = HERE / "claim-audit-r7-registry-20260829.json"
OUT = HERE / "claim-audit-r7-provenance-seal-20260829.json"
OUT_SHA = HERE / "claim-audit-r7-provenance-seal-20260829.json.sha256"
...
def build_payload() -> dict[str, Any]:
    ...
    payload = {
        "schema_version": "1.1",
        "artifact_type": "c1-r7-replayable-claim-audit",
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Replay the C1 R7 35-claim manuscript audit")
    ...
    if payload["status"] != "PASS":
        ...
        raise RuntimeError(f"R7 claim audit failed: {failed}")
