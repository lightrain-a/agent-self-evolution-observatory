...
\paragraph{Skills and evolving controllers.}
Clone/lifecycle work handles redundancy~\citep{zhu2026skillclone,liu2026skillsvote}, safety studies trace failures from skill content~\citep{mao2026practiceunsafe,dong2026agentskills}, and ERSkill, Skill-SP, SkillRL, and SHAPER learn routers or co-evolve libraries~\citep{chen2026erskill,huang2026skill,xia2026skillrl,wang2026shaper}. None tests semantic-control invariance to semantics-preserving package refactoring while support is held fixed; STRI does, and the Level-1 residual survives exact-clone quotienting.

\paragraph{Exposure allocation, optimization, and scope.}
Skill compression and structured bandits share reusable structure~\citep{bai2026skillzip,slivkins2011contextual,sen2018stochastic}, while fair ranking optimizes utility under exposure constraints~\citep{singh2018fairness}. STRI instead audits whether taxonomy refactoring changes semantic control opportunity. Eq.~\eqref{eq:rstar} is adjacent to fractional covering, matrix scaling, fairness, discrepancy, and cone/duality theory~\citep{lovasz1975fractional,sinkhorn1967nonnegative,radunovic2007fairness,beck1981integer,boyd2004convex}; we claim no new optimization algorithm. Proposition~3 gives a quantitative dual bound and sparse witnesses. Our claims are released representation sensitivity, exact support-cone realizability, and one bounded AutoSkill P19 chain; we \textbf{do not} claim task utility, longitudinal regret, system-wide safety, LP novelty, or a broadly validated repair. Dynamic evidence is one substrate/executor; neutral $q=\mathbf1$ is the no-priority audit.
