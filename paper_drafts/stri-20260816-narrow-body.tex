...
Skill-SP/SkillRL establish identity sensitivity; frozen support regimes and the SkillRouter relevance analogue show geometry---not overlap or average fit---separates residual from equalizable cases. Conditional on $A,q$, $R^*=1$ keeps package retuning viable, $R^*>1$ rules out that same-information class, and invalid provenance redirects to identification. AutoSkill is one bounded behavior existence proof; it and the SkillRL phenotype neither supports population utility, safety, or regret; semantic-first remains constructive, not a validated repair.
