...
rec['status']=='STAGE_RESOLVED_B12_INTEGRATED_QA_PASS',rec['story_winner_changed'] is False,rec['external_review_calls_current_revision']==0,rec['canonical_stable_registry_overwritten'] is False,p['revision']=='iclr-stage-resolved-b12-crossdomain-20260824',p['claim_expansion'] is False,p['story_winner_changed'] is False,p['reddit_native_gate_pass'] is False,p['full_paper_observable_provider_posts_lower_bound']==2159,p['canonical_stable_registry_overwritten'] is False,counts['b12-reddit-retrieval.csv']==129,counts['b12-r1-writer.csv']==8,counts['b12-r1-terminal.csv']==64]
