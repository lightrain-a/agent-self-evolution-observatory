...
Together, the financial-agent audit and reward-inflation results support a causal model in which memory provenance changes the distribution of future behavior. The matched provenance experiment in Section~\ref{sec:intervention} provides the direct test.
