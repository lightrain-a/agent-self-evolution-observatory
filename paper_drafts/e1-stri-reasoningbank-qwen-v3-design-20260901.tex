...
exclusions and evaluator qualification, without policy outcomes. The pinned dataset's
difficulty field is descriptive only because a separate exact provenance package for
official human difficulty annotations was not content-addressed before outcomes; it
is not used for selection, exclusion, stratification, or confirmatory adjustment.
Source, calibration, pilot, and confirmatory tasks are permanently disjoint. The
