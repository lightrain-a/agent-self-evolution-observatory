...
RECEIPT="$ROOT/generated/behavior-formal-goal-coupling-shared26-pi05-source-train-compile-probe-v5a-result-20260902.json"
LOG=/data/wyt/formal-goal-pi05-source-train-compile-probe-v5a-20260902.log
...
exec systemd-run --user --scope --quiet \
  ...
  /usr/bin/taskset -c 0-63 /usr/bin/env \
    ...
    "$PYTHON" "$ROOT/research_pipeline/behavior_formal_goal_coupling_shared26_pi05_source_train_compile_probe_v5a.py" \
      --authority "$ROOT/generated/behavior-formal-goal-coupling-shared26-pi05-source-train-compile-probe-v5a-authority-20260902.json" \
