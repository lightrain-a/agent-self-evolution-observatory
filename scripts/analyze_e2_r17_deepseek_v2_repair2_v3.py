...
def validate_analysis_gate(
    *,
    ...
    require(not output_path.exists(), "V3 scientific adjudication already exists; analyzer is single-use")
    ...
    require(summary.get("status") == SUMMARY_STATUS, "V3 summary incomplete")
    ...
    # The full integrity audit is validated before any score-bearing artifact is opened.
...
def main() -> int:
    ...
    payload = {
        "schema_version": "1.0",
        "artifact_type": "e2-r17-deepseek-v2-repair2-v3-scientific-adjudication",
        ...
        "provider_claims_v3_fresh": audit["v3_fresh_provider_claims"],
