...
AUTH="$ROOT/generated/behavior-formal-goal-coupling-shared26-pi05-practical-batch16-formal-training-authority-20260903.json"
SMOKE="$ROOT/generated/behavior-formal-goal-coupling-shared26-pi05-practical-batch16-real-data-zero-update-smoke-result-20260903.json"
PROGRESS="$ROOT/generated/behavior-formal-goal-coupling-shared26-pi05-practical-batch16-formal-training-progress-20260903.json"
RESULT="$ROOT/generated/behavior-formal-goal-coupling-shared26-pi05-practical-batch16-formal-training-result-20260903.json"
LOG=/data/wyt/formal-goal-pi05-practical-batch16-formal-train-20260903.log
exec >>"$LOG" 2>&1
[[ -f "$AUTH" && -f "$SMOKE" && -f "$SEAL" ]] || { echo "authority/smoke/seal missing"; exit 3; }
