...
def main() -> None:
    parser = argparse.ArgumentParser(description="Record a real final venue decision for a paper currently in REBUTTAL. The decision does not change scientific claim truth.")
