...
from research_pipeline.relational_topology_official_training_dev_v15a import COMPONENTS, preflight
from research_pipeline.relational_topology_official_training_dev_run_v17a import train


def code_sha() -> str:
    paths=[
        ROOT/"research_pipeline/relational_topology_official_training_dev_v15a.py",
        ROOT/"research_pipeline/relational_topology_official_training_dev_run_v15a.py",
        ROOT/"research_pipeline/relational_topology_official_training_dev_run_v16a.py",
        ROOT/"research_pipeline/relational_topology_official_training_dev_run_v17a.py",
