...
RECEIPT="$ROOT/generated/behavior-formal-goal-coupling-shared26-pi05-microbatch32-gradient-probe-v6a-result-20260902.json"
LOG=/data/wyt/formal-goal-pi05-microbatch32-gradient-probe-v6a-20260902.log
...
exec systemd-run --user --scope --quiet \
  ...
  /usr/bin/taskset -c 0-63 /usr/bin/env \
    HF_HUB_OFFLINE=1 TRANSFORMERS_OFFLINE=1 OPENPI_DATA_HOME="$OPENPI_DATA_HOME" \
    ...
    "$PYTHON" "$ROOT/research_pipeline/behavior_formal_goal_coupling_shared26_pi05_microbatch32_gradient_probe_v6a.py" \
      --authority "$ROOT/generated/behavior-formal-goal-coupling-shared26-pi05-microbatch32-gradient-probe-v6a-authority-20260902.json" \
      --failure-adjudication "$ROOT/generated/behavior-formal-goal-coupling-shared26-pi05-source-train-memory-plan-adjudication-20260902.json" \
