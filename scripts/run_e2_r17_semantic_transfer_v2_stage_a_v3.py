...
EXPECTED_CONTRACT_STATUS = "FROZEN_SEMANTIC_TRANSFER_V2_STAGE_A_V3"
EXPECTED_AUTH_STATUS = "AUTHORIZED_SEMANTIC_TRANSFER_V2_STAGE_A_V3"
...
def main() -> int:
    ...
    require(len(all_tasks) == 144 and len(set(all_tasks)) == 144, "Stage-A V3 task set drift")
    ...
    try:
        ...
        require(len(completed_rows) == 18, "Stage-A V3 did not complete all streams")
        total_rollouts = 0
        ...
        require(total_rollouts == 1152, f"Stage-A V3 rollout count drift: {total_rollouts}")
