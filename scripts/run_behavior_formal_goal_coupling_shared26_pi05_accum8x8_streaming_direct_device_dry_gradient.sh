...
RECEIPT="$ROOT/generated/behavior-formal-goal-coupling-shared26-pi05-accum8x8-streaming-direct-device-dry-gradient-repair1-result-20260902.json"
LOG=/data/wyt/formal-goal-pi05-accum8x8-streaming-direct-device-dry-gradient-repair1-20260902.log
...
exec systemd-run --user --scope --quiet -p MemoryMax=72G -p MemorySwapMax=0 -p TasksMax=512 \
  ...
  --authority "$ROOT/generated/behavior-formal-goal-coupling-shared26-pi05-accum8x8-streaming-direct-device-dry-gradient-repair1-authority-20260902.json" \
  ...
  --direct-device-model-load-result "$ROOT/generated/behavior-formal-goal-coupling-shared26-pi05-direct-device-no-update-model-load-result-20260902.json" \
