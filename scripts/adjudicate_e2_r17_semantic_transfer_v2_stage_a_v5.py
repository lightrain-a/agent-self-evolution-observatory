...
def main() -> int:
    ...
    require(contract.get("status") == "FROZEN_SEMANTIC_TRANSFER_V2_STAGE_A_V5", "Stage-A V5 contract status invalid")
    require(auth.get("status") == "AUTHORIZED_SEMANTIC_TRANSFER_V2_STAGE_A_V5", "Stage-A V5 authorization status invalid")
