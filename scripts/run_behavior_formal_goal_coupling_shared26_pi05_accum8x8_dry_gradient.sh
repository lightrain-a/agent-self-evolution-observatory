...
RECEIPT="$ROOT/generated/behavior-formal-goal-coupling-shared26-pi05-accum8x8-dry-gradient-result-20260902.json"
LOG=/data/wyt/formal-goal-pi05-accum8x8-dry-gradient-20260902.log
...
exec systemd-run --user --scope --quiet -p MemoryMax=72G -p MemorySwapMax=0 -p TasksMax=512 \
  ...
  "$PYTHON" "$ROOT/research_pipeline/behavior_formal_goal_coupling_shared26_pi05_accum8x8_dry_gradient.py" \
  --authority "$ROOT/generated/behavior-formal-goal-coupling-shared26-pi05-accum8x8-dry-gradient-authority-20260902.json" \
  ...
  --v4-adjudication "$ROOT/generated/behavior-formal-goal-coupling-shared26-pi05-accum16x4-resource-failure-adjudication-20260902.json" \
