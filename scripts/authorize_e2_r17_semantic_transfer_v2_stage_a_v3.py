...
EXPECTED_PREFLIGHT_STATUS = "PASS_ZERO_PROVIDER_SEMANTIC_TRANSFER_V2_STAGE_A_V3_PREFLIGHT"
...
def main() -> int:
    ...
    payload = {
        "schema_version": "1.0",
        "artifact_type": "e2-r17-semantic-transfer-v2-stage-a-v3-authorization",
        "created_at_utc": datetime.now(timezone.utc).isoformat(timespec="seconds"),
        "status": "AUTHORIZED_SEMANTIC_TRANSFER_V2_STAGE_A_V3",
