...
def main() -> int:
    ...
    require(summary.get("status") == SUMMARY_STATUS, "Continuation V2 run incomplete")
    ...
    require(audit.get("global_lineage_lease_complete_pass") is True, "terminal lineage lease not proven")
    ...
    payload = {
        ...
        "interpretation_boundary": (
            ...
            "DeepSeek V2 Repair2 Continuation V2 canonical 48-pair sample. It grants no provider, "
            "updater, evaluator, second-model, public-benchmark, paper, or submission authority."
        ),
    }
