...
def main() -> int:
    ...
    require(contract.get("status") == "FROZEN_SEMANTIC_TRANSFER_V2_STAGE_A_V3", "Stage-A V3 contract status invalid")
    require(auth.get("status") == "AUTHORIZED_SEMANTIC_TRANSFER_V2_STAGE_A_V3", "Stage-A V3 authorization status invalid")
