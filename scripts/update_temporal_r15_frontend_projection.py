...
def main():
    ...
    p=d['papers'][PID]
    p['read']={
      'zh':'Round 2 历史文字 verdict 为 Weak Accept；最新 R14 post-repair 外审为 6.0 / Accept。R15 已完成针对性 paper/analysis repair，scientific contract 不变，当前仍为 SUBMISSION_READY / NO_INTERNAL_ACTION。',
      'en':'The historical Round-2 textual verdict is Weak Accept; the latest R14 post-repair review is 6.0 / Accept. R15 completes targeted paper/analysis repair with the scientific contract unchanged and remains SUBMISSION_READY / NO_INTERNAL_ACTION.'}
    p['next']={
      'zh':'不再自动扩实验。R15 已吸收 Accept 审稿中的 margin/power、Rsurf residual、scorer、causal bookkeeping 与 multi-turn guidance；benign generic / 更多 non-ceiling / prospective cross-domain 只在未来扩大 claim 时 scientific reopen。',
      'en':'Do not expand experiments automatically. R15 absorbs the Accept review through margin/power, Rsurf residual, scorer, causal-bookkeeping, and multi-turn guidance; a benign generic, more non-ceiling coverage, or prospective cross-domain work requires scientific reopen only for broader future claims.'}
    for o in p['objections']:
        ...
        if oid=='TEMP-O4':
            ...
            o.update({'d':'PERMANENT_CLAIM_BOUNDARY','why':{
              ...
              'en':'R14 executes exact-output Rsurf, which only identifies integration-surface placement under the forced one-answer harness and is not an independent temporal retriever. The paper explicitly removes skill-vs-temporal-RAG equivalence/superiority claims; a real independent retriever is a reopen condition for a broader future claim, not a gap in the current one.'},'action':'NONE','e':'R14 Rsurf 18-endpoint frozen-margin check + R15 residual/power/scorer analysis','canon':'R15_CURRENT_CANONICAL'})
            o['reopen']={
    ...
    d['summary'].update({
      ...
      'automatic_actions':0})
    d['rechecked_at_utc']='2026-08-24T05:53:03.864511+00:00'
    d['recheck']='Round 2 reviewer text preserved; current Temporal dispositions reconciled to canonical R15 after fresh R14 post-repair review (6.0 / Accept). No new experiment opened.'
