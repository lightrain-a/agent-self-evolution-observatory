...
CONTRACT_STATUS = "FROZEN_SEMANTIC_TRANSFER_V2_STAGE_A_V3"
...
def main() -> int:
    ...
    req(len(all_tasks) == 144 and len(set(all_tasks)) == 144, "V3 update task shape invalid")
    req(len(heldout) == 18 and len(set(heldout)) == 18 and set(all_tasks).isdisjoint(heldout), "V3 heldout separation invalid")
    ...
    payload = {
        "schema_version": "1.0",
        "artifact_type": "e2-r17-semantic-transfer-v2-stage-a-v3-zero-provider-preflight",
        "created_at_utc": datetime.now(timezone.utc).isoformat(timespec="seconds"),
        "status": "PASS_ZERO_PROVIDER_SEMANTIC_TRANSFER_V2_STAGE_A_V3_PREFLIGHT",
        ...
        "next_gate": "LOCKED_DUAL_PREEXECUTION_REVIEW_AND_FRESH_IDENTITY_BEFORE_SINGLE_USE_STAGE_A_V3_AUTHORIZATION"
    }
