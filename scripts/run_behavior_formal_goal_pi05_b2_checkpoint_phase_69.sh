...
AUTH="$ROOT/generated/behavior-formal-goal-coupling-shared26-pi05-b2-leaf-batched-checkpoint-qualification-authority-69-20260905.json"
REVIEW="$ROOT/generated/behavior-formal-goal-coupling-shared26-pi05-b2-host69-substitution-independent-review-20260905.json"
...
SAVE_RUNNER="$ROOT/research_pipeline/behavior_formal_goal_coupling_shared26_pi05_b2_checkpoint_save_qualification_69.py"
VERIFY_RUNNER="$ROOT/research_pipeline/behavior_formal_goal_coupling_shared26_pi05_b2_checkpoint_verify_69.py"
OUT=/data/wyt/formal-goal-checkpoint-save-qualification-69-20260905/b2-leaf-batched-8gb-52g
SAVE_RESULT="$ROOT/generated/behavior-formal-goal-coupling-shared26-pi05-b2-checkpoint-save-result-69-20260905.json"
DISK_RESULT="$ROOT/generated/behavior-formal-goal-coupling-shared26-pi05-b2-disk-verify-result-69-20260905.json"
RESTORE_RESULT="$ROOT/generated/behavior-formal-goal-coupling-shared26-pi05-b2-standard-restore-result-69-20260905.json"
TMPROOT=/data/wyt/formal-goal-b2-tmp-69-20260905
mkdir -p "$TMPROOT"
...
case "$PHASE" in
  save)
    ...
    run_unit pi05-b2-checkpoint-save-69-20260905.service cuda \
      "$PY" "$SAVE_RUNNER" \
  ...
  disk)
    ...
    run_unit pi05-b2-disk-verify-69-20260905.service cpu \
  ...
  restore)
    ...
    run_unit pi05-b2-standard-restore-69-20260905.service cuda \
