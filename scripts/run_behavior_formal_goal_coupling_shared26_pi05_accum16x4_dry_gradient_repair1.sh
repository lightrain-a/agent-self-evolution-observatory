...
RECEIPT="$ROOT/generated/behavior-formal-goal-coupling-shared26-pi05-accum16x4-dry-gradient-repair1-result-20260902.json"
LOG=/data/wyt/formal-goal-pi05-accum16x4-dry-gradient-repair1-20260902.log
...
exec systemd-run --user --scope --quiet -p MemoryMax=72G -p MemorySwapMax=0 -p TasksMax=512 \
  ...
  "$PYTHON" "$ROOT/research_pipeline/behavior_formal_goal_coupling_shared26_pi05_accum16x4_dry_gradient_repair1.py" \
  --authority "$ROOT/generated/behavior-formal-goal-coupling-shared26-pi05-accum16x4-dry-gradient-repair1-authority-20260902.json" \
