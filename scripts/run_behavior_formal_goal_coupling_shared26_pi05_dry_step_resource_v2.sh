...
RECEIPT="$ROOT/generated/behavior-formal-goal-coupling-shared26-pi05-dry-step-resource-v2-result-20260902.json"
LOG="/data/wyt/formal-goal-pi05-dry-step-resource-v2-20260902.log"

if [[ -e "$RECEIPT" ]]; then
  echo "Refusing to replay exactly-once resource-v2 receipt: $RECEIPT" >&2
  exit 2
fi
...
exec systemd-run --user --scope --quiet \
  ...
  /usr/bin/env \
    ...
    "$PYTHON" "$ROOT/research_pipeline/behavior_formal_goal_coupling_shared26_pi05_dry_step_resource_v2.py" \
      --authority "$ROOT/generated/behavior-formal-goal-coupling-shared26-pi05-dry-step-resource-v2-authority-20260902.json" \
      --failure-adjudication "$ROOT/generated/behavior-formal-goal-coupling-shared26-pi05-dry-step-resource-failure-adjudication-20260902.json" \
